...
class env(): 
    ...
    def reset(self, episode): #초기화하고 state를 보내준다
        ...
        if episode == "Test":
            ...
            #data_frame_init = pd.read_csv(r"/home/fish991/code/Half_staggered/Test_folder/Test_dudw/mid dataset/mid dataset epTest t_real20000.csv", encoding = "ISO-8859-1")
        ...
        self.next_state_b[:,:,0] = next_state_stock[2]#; self.next_state_b[:,:,1] = next_state_stock[2]
        self.next_state_t[:,:,0] = next_state_stock[3]#; self.next_state_t[:,:,1] = next_state_stock[3]
